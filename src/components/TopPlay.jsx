...
const TopChartCard = ({
  ...
  return (
    ...
    py-2 p-4 rounded-lg cursor-pointer mb-2 font-bold text-base text-white"
    >
      <h3 className="mr-3">{i + 1}</h3>
        ...
        <div className="mt-4 flex flex-col gap-1">
          {topPlays?.map((song, i) => (
            <TopChartCard
              ...
              handlePalyClick={() => handlePlayClick(song, i)}
              activeSong={activeSong}
            />
          ))}
        </div>
